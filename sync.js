...
var datetime = __webpack_require__(1);
...
var parseSignature = __webpack_require__(5);
...
var jsonata = function () {
   ...
   */
  const functionEval = _async(function (expr, focus) {
    let _exit1 = false;
    var ast, result;
    const _this2 = this;
    ...
    return _continue(_catch(function () {
      return _await(evaluate(ast, input, _this2.environment), function (_evaluate12) {
        result = _evaluate12;
      });
    }, function (err) {
      ...
      return _exit1 ? _result18 : result;
    });
  });
  /**
   * Clones an object
   ...
   */
  const applyNativeFunction = _async(function (proc, env) {
    ...
    return _invoke(function () {
      if (isPromise(result)) {
        return _await(result, function (_result17) {
          result = _result17;
        });
      }
    }, function () {
   ...
   */
  const applyProcedure = _async(function (proc, args) {
    var result;
    ...
    return _invoke(function () {
      if (typeof proc.body === 'function') {
        ...
        return _await(applyNativeFunction(proc.body, env), function (_applyNativeFunction) {
          result = _applyNativeFunction;
        });
      } else {
        return _await(evaluate(proc.body, proc.input, env), function (_evaluate11) {
          result = _evaluate11;
        });
      }
    }, function () {
   ...
   */
  const evaluatePartialApplication = _async(function (expr, input, environment) {
    ...
    return _continue(_for(function () {
      return ii < expr.arguments.length;
    }, function () {
      return ii++;
    }, function () {
      ...
      return _invokeIgnored(function () {
        if (arg.type === 'operator' && arg.value === '?') {
          ...
          const _push2 = evaluatedArgs.push;
          return _await(evaluate(arg, input, environment), function (_evaluate10) {
            _push2.call(evaluatedArgs, _evaluate10);
          });
        }
      });
    }), function () {
      // lookup the procedure
      return _await(evaluate(expr.procedure, input, environment), function (proc) {
   ...
   * @returns {*} Result of procedure
   */
  const applyInner = _async(function (proc, args, input, environment) {
    let _exit0 = false;
    var result;
    return _continue(_catch(function () {
      ...
      return function () {
        if (isLambda(proc)) {
          return _await(applyProcedure(proc, validatedArgs), function (_applyProcedure) {
            result = _applyProcedure;
          });
          ...
          if (proc && proc._jsonata_function === true) {
            ...
            return _invokeIgnored(function () {
              if (isPromise(result)) {
                return _await(result, function (_result12) {
                  result = _result12;
                });
              }
            });
            ...
            if (typeof proc === 'function') {
              ...
              return _invokeIgnored(function () {
                if (isPromise(result)) {
                  return _await(result, function (_result14) {
                    result = _result14;
                  });
                }
              });
      ...
      return _exit0 ? _result16 : result;
    });
  });
  /**
   ...
   * @returns {*} Result of procedure
   */
  const apply = function (proc, args, input, environment) {
    var result;
    return _await(applyInner(proc, args, input, environment), function (_applyInner) {
      result = _applyInner;
      return _continue(_for(function () {
        return !!isLambda(result) && result.thunk === true;
      }, void 0, function () {
        // trampoline loop - this gets invoked as a result of tail-call optimization
        // the function returned a tail-call thunk
        // unpack it, evaluate its arguments, and apply the tail call
        return _await(evaluate(result.body.procedure, result.input, result.environment), function (next) {
          ...
          var ii = 0;
          return _continue(_for(function () {
            return ii < result.body.arguments.length;
          }, function () {
            return ii++;
          }, function () {
            const _push = evaluatedArgs.push;
            return _await(evaluate(result.body.arguments[ii], result.input, result.environment), function (_evaluate1) {
              _push.call(evaluatedArgs, _evaluate1);
            });
          }), function () {
            return _await(applyInner(next, evaluatedArgs, input, environment), function (_applyInner2) {
              result = _applyInner2;
            });
          });
        });
   ...
   * @returns {*} Evaluated input data
   */
  const evaluateFunction = _async(function (expr, input, environment, applyto) {
    var result;
    ...
    return _await(evaluate(expr.procedure, input, environment), function (proc) {
      ...
      var jj = 0;
      return _continue(_for(function () {
        return jj < expr.arguments.length;
      }, function () {
        return jj++;
      }, function () {
        return _await(evaluate(expr.arguments[jj], input, environment), function (arg) {
          if (isFunction(arg)) {
            // wrap this in a closure
            const closure = function (...params) {
              // invoke func
              return _await(apply(arg, params, null, environment));
            };
        ...
        return _continue(_catch(function () {
          ...
          return _await(apply(proc, evaluatedArgs, input, environment), function (_apply4) {
            result = _apply4;
          });
        }, function (err) {
          if (!err.position) {
          ...
          return _exit9 ? _result10 : result;
        });
      });
    });
  });
   ...
   * @returns {*} Evaluated input data
   */
  const evaluateApplyExpression = _async(function (expr, input, environment) {
    var result;
    return _await(evaluate(expr.lhs, input, environment), function (lhs) {
      let _exit8 = false;
      return _invoke(function () {
        if (expr.rhs.type === 'function') {
          // this is a function _invocation_; invoke it with lhs expression as the first argument
          return _await(evaluateFunction(expr.rhs, input, environment, {
            context: lhs
          }), function (_evaluateFunction2) {
            result = _evaluateFunction2;
          });
        } else {
          return _await(evaluate(expr.rhs, input, environment), function (func) {
            if (!isFunction(func)) {
              throw {
                code: "T2006",
                stack: new Error().stack,
            ...
            return _invokeIgnored(function () {
              if (isFunction(lhs)) {
                ...
                // λ($f, $g) { λ($x){ $g($f($x)) } }
                return _await(evaluate(chainAST, null, environment), function (chain) {
                  return _await(apply(chain, [lhs, func], null, environment), function (_apply2) {
                    result = _apply2;
                  });
                });
              } else {
                return _await(apply(func, [lhs], null, environment), function (_apply3) {
                  result = _apply3;
                });
              }
            });
   ...
   */
  const evaluateSortExpression = _async(function (expr, input, environment) {
    var result;
    ...
    var comparator = _async(function (a, b) {
      let _exit7 = false;
      // expr.terms is an array of order-by in priority order
      var comp = 0;
      var index = 0;
      return _continue(_for(function () {
        return !_exit7 && comp === 0 && index < expr.terms.length;
      }, function () {
        return index++;
      }, function () {
        ...
        return _await(evaluate(term.expression, context, env), function (aa) {
          ...
          return _await(evaluate(term.expression, context, env), function (bb) {
            // type checks
            var atype = typeof aa;
            var btype = typeof bb;
    ...
    // the `focus` is passed in as the `this` for the invoked function
    return _await(fn.sort.apply(focus, [lhs, comparator]), function (_fn$sort$apply) {
      result = _fn$sort$apply;
      return result;
    });
  });
  /**
   ...
   * @returns {*} Evaluated input data
   */
  const evaluateBlock = _async(function (expr, input, environment) {
    var result;
    ...
    var ii = 0;
    return _continue(_for(function () {
      return ii < expr.expressions.length;
    }, function () {
      return ii++;
    }, function () {
      return _await(evaluate(expr.expressions[ii], input, frame), function (_evaluate0) {
        result = _evaluate0;
      });
    }), function () {
      return result;
   ...
   * @returns {*} Evaluated input data
   */
  const evaluateCondition = _async(function (expr, input, environment) {
    var result;
    return _await(evaluate(expr.condition, input, environment), function (condition) {
      return _invoke(function () {
        if (fn.boolean(condition)) {
          return _await(evaluate(expr.then, input, environment), function (_evaluate8) {
            result = _evaluate8;
          });
        } else return _invokeIgnored(function () {
          if (typeof expr.else !== 'undefined') {
            return _await(evaluate(expr.else, input, environment), function (_evaluate9) {
              result = _evaluate9;
            });
          }
        });
   ...
   * @returns {*} Evaluated input data
   */
  const evaluateBindExpression = _async(function (expr, input, environment) {
    // The RHS is the expression to evaluate
    // The LHS is the name of the variable to bind to - should be a VARIABLE token (enforced by parser)
    return _await(evaluate(expr.rhs, input, environment), function (value) {
   ...
   * @returns {{}} Evaluated input data
   */
  const evaluateGroupExpression = _async(function (expr, input, environment) {
    let _exit6 = false;
    var key, key, value;
    var result = {};
    var groups = {};
    ...
    return _continue(_forTo(input, function (itemIndex) {
      var item = input[itemIndex];
      var env = reduce ? createFrameFromTuple(environment, item) : environment;
      var pairIndex = 0;
      return _for(function () {
        return !_exit6 && pairIndex < expr.lhs.length;
      }, function () {
        return pairIndex++;
      }, function () {
        var pair = expr.lhs[pairIndex];
        return _await(evaluate(pair[0], reduce ? item['@'] : item, env), function (_evaluate6) {
          key = _evaluate6;
      ...
      return _exit6 ? _result9 : _await(Promise.all(Object.keys(groups).map(_async(function (key, idx) {
        ...
        return _await(evaluate(expr.lhs[entry.exprIndex][1], context, env), function (_evaluate7) {
          return [key, _evaluate7];
        });
      }))), function (generators) {
        return _continue(_forOf(generators, function (generator) {
          return _await(generator, function (_generator) {
            [key, value] = _generator;
   ...
   * @returns {*} Result
   */
  const evaluateBooleanExpression = _async(function (lhs, evalrhs, op) {
    let _interrupt5 = false;
    var result;
    var lBool = boolize(lhs);
    return _continue(_switch(op, [[function () {
      return 'and';
    }, function () {
      return _await(lBool && evalrhs(), function (_evalrhs) {
        result = lBool && boolize(_evalrhs);
        _interrupt5 = true;
      }, !lBool);
    }], [function () {
      return 'or';
    }, function () {
      return _await(lBool || evalrhs(), function (_evalrhs2) {
        result = lBool || boolize(_evalrhs2);
        _interrupt5 = true;
      }, lBool);
    }]]), function () {
      return result;
   ...
   * @returns {*} Evaluated input data
   */
  const evaluateUnary = _async(function (expr, input, environment) {
    let _exit5 = false,
      _interrupt4 = false;
    var result;
    return _continue(_switch(expr.value, [[function () {
      return '-';
    }, function () {
      return _await(evaluate(expr.expression, input, environment), function (_evaluate4) {
        result = _evaluate4;
      ...
      result = [];
      return _await(Promise.all(expr.expressions.map(_async(function (item, idx) {
        environment.isParallelCall = idx > 0;
        return _await(evaluate(item, input, environment), function (_evaluate5) {
          return [item, _evaluate5];
        });
      }))), function (generators) {
      ...
      return _await(evaluateGroupExpression(expr, input, environment), function (_evaluateGroupExpress3) {
        result = _evaluateGroupExpress3;
        _interrupt4 = true;
      });
    }]]), function (_result7) {
      return _exit5 ? _result7 : result;
    });
  });
  /**
   ...
   * @returns {*} Evaluated input data
   */
  const evaluateBinary = _async(function (expr, input, environment) {
    var result;
    return _await(evaluate(expr.lhs, input, environment), function (lhs) {
      let _exit4 = false;
      var op = expr.value;
      ...
      return _invoke(function () {
        if (op === "and" || op === "or") {
          return _catch(function () {
            _exit4 = true;
            return _await(evaluateBooleanExpression(lhs, evalrhs, op));
          }, function (err) {
            err.position = expr.position;
            err.token = op;
            throw err;
        ...
        return _exit4 ? _result6 : _call(evalrhs, function (rhs) {
          try {
            switch (op) {
              case '+':
              case '-':
   ...
   */
  const evaluateFilter = _async(function (predicate, input, environment) {
    var index, item, item;
    ...
    return _invoke(function () {
      if (predicate.type === 'number') {
        ...
        return _await(input[index], function (_input$index) {
          item = _input$index;
        ...
        return _continueIgnored(_for(function () {
          ...
          return _await(evaluate(predicate, context, env), function (res) {
            if (isNumeric(res)) {
              res = [res];
            }
   ...
   * @returns {*} Evaluated input data
   */
  const evaluateTupleStep = _async(function (expr, input, tupleBindings, environment) {
    let _exit3 = false;
    var tuple;
    var result;
    return _invoke(function () {
      if (expr.type === 'sort') {
        return _invoke(function () {
          if (tupleBindings) {
            return _await(evaluateSortExpression(expr, tupleBindings, environment), function (_evaluateSortExpressi2) {
              result = _evaluateSortExpressi2;
            });
          } else {
            return _await(evaluateSortExpression(expr, input, environment), function (sorted) {
          ...
          return _invoke(function () {
            if (expr.stages) {
              return _await(evaluateStages(expr.stages, result, environment), function (_evaluateStages2) {
                result = _evaluateStages2;
              });
            }
          }, function () {
            _exit3 = true;
      ...
      return _continue(_forTo(tupleBindings, function (ee) {
        stepEnv = createFrameFromTuple(environment, tupleBindings[ee]);
        return _await(evaluate(expr, tupleBindings[ee]['@'], stepEnv), function (res) {
        ...
        return _invoke(function () {
          if (expr.stages) {
            return _await(evaluateStages(expr.stages, result, environment), function (_evaluateStages3) {
              result = _evaluateStages3;
            });
          }
        }, function () {
          return result;
  ...
  const evaluateStages = _async(function (stages, input, environment) {
    var result = input;
    return _continue(_forTo(stages, function (ss) {
      let _interrupt3 = false;
      var stage = stages[ss];
      return _continueIgnored(_switch(stage.type, [[function () {
        return 'filter';
      }, function () {
        return _await(evaluateFilter(stage.expr, result, environment), function (_evaluateFilter3) {
          result = _evaluateFilter3;
          _interrupt3 = true;
        });
      }], [function () {
        return 'index';
   ...
   * @returns {*} Evaluated input data
   */
  const evaluateStep = _async(function (expr, input, environment, lastStep) {
    let _exit2 = false;
    var result;
    return _invoke(function () {
      if (expr.type === 'sort') {
        return _await(evaluateSortExpression(expr, input, environment), function (_evaluateSortExpressi) {
          result = _evaluateSortExpressi;
          return _invoke(function () {
            if (expr.stages) {
              return _await(evaluateStages(expr.stages, result, environment), function (_evaluateStages) {
                result = _evaluateStages;
              });
            }
          }, function () {
            _exit2 = true;
      ...
      result = createSequence();
      return _continue(_forTo(input, function (ii) {
        return _await(evaluate(expr, input[ii], environment), function (res) {
          return _invoke(function () {
            if (expr.stages) {
              var ss = 0;
              return _continueIgnored(_for(function () {
                return ss < expr.stages.length;
              }, function () {
                return ss++;
              }, function () {
                return _await(evaluateFilter(expr.stages[ss].expr, res, environment), function (_evaluateFilter2) {
                  res = _evaluateFilter2;
                });
              }));
            }
          }, function () {
   ...
   * @returns {*} Evaluated input data
   */
  const evaluatePath = _async(function (expr, input, environment) {
    let _interrupt2 = false;
    var ii;
    var inputSequence;
    ...
    ii = 0;
    return _continue(_for(function () {
      return !_interrupt2 && ii < expr.steps.length;
    }, function () {
      return ii++;
    }, function () {
      ...
      return _invoke(function () {
        if (ii === 0 && step.consarray) {
          return _await(evaluate(step, inputSequence, environment), function (_evaluate2) {
            resultSequence = _evaluate2;
          });
        } else {
          return _invokeIgnored(function () {
            if (isTupleStream) {
              return _await(evaluateTupleStep(step, inputSequence, tupleBindings, environment), function (_evaluateTupleStep) {
                tupleBindings = _evaluateTupleStep;
              });
            } else {
              return _await(evaluateStep(step, inputSequence, environment, ii === expr.steps.length - 1), function (_evaluateStep) {
                resultSequence = _evaluateStep;
              });
            }
          });
        }
      ...
      return _invoke(function () {
        if (expr.hasOwnProperty('group')) {
          return _await(evaluateGroupExpression(expr.group, isTupleStream ? tupleBindings : resultSequence, environment), function (_evaluateGroupExpress2) {
            resultSequence = _evaluateGroupExpress2;
          });
        }
      }, function () {
        return resultSequence;
   ...
   * @returns {*} Evaluated input data
   */
  const evaluate = _async(function (expr, input, environment) {
    var result;
    var entryCallback = environment.lookup(Symbol.for('jsonata.__evaluate_entry'));
    return _invoke(function () {
      if (entryCallback) {
        return _awaitIgnored(entryCallback(expr, input, environment));
      }
    }, function () {
      return _continue(_switch(expr.type, [[function () {
        return 'path';
      }, function () {
        return _await(evaluatePath(expr, input, environment), function (_evaluatePath) {
          result = _evaluatePath;
        });
      }], [function () {
        return 'binary';
      }, function () {
        return _await(evaluateBinary(expr, input, environment), function (_evaluateBinary) {
          result = _evaluateBinary;
        });
      }], [function () {
        return 'unary';
      }, function () {
        return _await(evaluateUnary(expr, input, environment), function (_evaluateUnary) {
          result = _evaluateUnary;
        });
      }], [function () {
        return 'name';
      }, function () {
        ...
        return _await(evaluateCondition(expr, input, environment), function (_evaluateCondition) {
          result = _evaluateCondition;
        });
      }], [function () {
        return 'block';
      }, function () {
        return _await(evaluateBlock(expr, input, environment), function (_evaluateBlock) {
          result = _evaluateBlock;
        });
      }], [function () {
        return 'bind';
      }, function () {
        return _await(evaluateBindExpression(expr, input, environment), function (_evaluateBindExpressi) {
          result = _evaluateBindExpressi;
        });
      }], [function () {
        return 'regex';
      }, function () {
        ...
        return _await(evaluateFunction(expr, input, environment), function (_evaluateFunction) {
          result = _evaluateFunction;
        });
      }], [function () {
        return 'variable';
      }, function () {
        ...
        return _await(evaluatePartialApplication(expr, input, environment), function (_evaluatePartialAppli) {
          result = _evaluatePartialAppli;
        });
      }], [function () {
        return 'apply';
      }, function () {
        return _await(evaluateApplyExpression(expr, input, environment), function (_evaluateApplyExpress) {
          result = _evaluateApplyExpress;
        });
      }], [function () {
        return 'transform';
      }, function () {
        ...
        return _invoke(function () {
          if (Object.prototype.hasOwnProperty.call(expr, 'predicate')) {
            var ii = 0;
            return _continueIgnored(_for(function () {
              return ii < expr.predicate.length;
            }, function () {
              return ii++;
            }, function () {
              return _await(evaluateFilter(expr.predicate[ii].expr, result, environment), function (_evaluateFilter) {
                result = _evaluateFilter;
              });
            }));
          }
        }, function () {
          return _invoke(function () {
            if (expr.type !== 'path' && Object.prototype.hasOwnProperty.call(expr, 'group')) {
              return _await(evaluateGroupExpression(expr.group, result, environment), function (_evaluateGroupExpress) {
                result = _evaluateGroupExpress;
              });
            }
          }, function () {
            ...
            return _invoke(function () {
              if (exitCallback) {
                return _awaitIgnored(exitCallback(expr, input, environment, result));
              }
            }, function () {
  ...
  function evaluateTransformExpression(expr, input, environment) {
    ...
    var transformer = _async(function (obj) {
      // signature <(oa):o>
      // undefined inputs always return undefined
      ...
      return _await(apply(cloneFunction, [obj], null, environment), function (result) {
        return _await(evaluate(expr.pattern, result, environment), function (matches) {
          let _exit = false;
          return _invoke(function () {
            if (typeof matches !== 'undefined') {
              ...
              return _forTo(matches, function (ii) {
                ...
                return _await(evaluate(expr.update, match, environment), function (update) {
                  ...
                  return function () {
                    if (typeof expr.delete !== 'undefined') {
                      return _await(evaluate(expr.delete, match, environment), function (deletions) {
  ...
  function evaluateLambda(expr, input, environment) {
    ...
    procedure.apply = _async(function (self, args) {
  ...
  function jsonata(expr, options) {
    ...
    return {
      evaluate: _async(function (input, bindings, callback) {
        var exec_env;
        ...
        var it;
        return _catch(function () {
          return _await(evaluate(ast, input, exec_env), function (_evaluate) {
            it = _evaluate;
...
const dateTime = function () {
  ...
  const few = ['Zero', 'One', 'Two', 'Three', 'Four', 'Five', 'Six', 'Seven', 'Eight', 'Nine', 'Ten', 'Eleven', 'Twelve', 'Thirteen', 'Fourteen', 'Fifteen', 'Sixteen', 'Seventeen', 'Eighteen', 'Nineteen'];
...
const functions = (() => {
   ...
   */
  const sift = _async(function (arg, func) {
    const _this8 = this;
    var result = {};
    return _continue(_forIn(arg, function (item) {
      var entry = arg[item];
      var func_args = hofFuncArgs(func, entry, item, arg);
      // invoke func
      return _await(func.apply(_this8, func_args), function (res) {
        if (boolean(res)) {
          result[item] = entry;
        }
      });
   ...
   */
  const sort = _async(function (arr, comparator) {
    var msort;
    // undefined inputs always return undefined
    ...
    var merge = _async(function (l, r) {
      var merge_iter;
      merge_iter = _async(function (result, left, right) {
        return _invokeIgnored(function () {
          if (left.length === 0) {
            ...
            } else return _await(comp(left[0], right[0]), function (_comp) {
              return _invokeIgnored(function () {
                if (_comp) {
                  // invoke the comparator function
                  // if it returns true - swap left and right
                  result.push(right[0]);
                  return _awaitIgnored(merge_iter(result, left, right.slice(1)));
                } else {
                  // otherwise keep the same order
                  result.push(left[0]);
                  return _awaitIgnored(merge_iter(result, left.slice(1), right));
                }
              });
            });
          });
      ...
      var merged = [];
      return _await(merge_iter(merged, l, r), function () {
        return merged;
      });
    });
    msort = _async(function (array) {
      if (!Array.isArray(array) || array.length <= 1) {
        ...
        return _await(msort(left), function (_msort) {
          left = _msort;
          return _await(msort(right), function (_msort2) {
            right = _msort2;
            return _await(merge(left, right));
          });
        });
      }
    });
   ...
   */
  const each = _async(function (obj, func) {
    const _this7 = this;
    var result = createSequence();
    return _continue(_forIn(obj, function (key) {
      var func_args = hofFuncArgs(func, obj[key], key, obj);
      // invoke func
      return _await(func.apply(_this7, func_args), function (val) {
   ...
   * @returns {*} Result
   */
  const foldLeft = _async(function (sequence, func, init) {
    const _this6 = this;
    // undefined inputs always return undefined
    ...
    return _continue(_for(function () {
      ...
      return _await(func.apply(_this6, args), function (_func$apply) {
        result = _func$apply;
        index++;
      });
    }), function () {
   ...
   */
  const single = _async(function (arr, func) {
    let _exit3 = false;
    const _this5 = this;
    // undefined inputs always return undefined
    if (typeof arr === 'undefined') {
    ...
    var result;
    return _continue(_forTo(arr, function (i) {
      var entry = arr[i];
      ...
      return _invoke(function () {
        if (typeof func !== 'undefined') {
          ...
          // invoke func
          return _await(func.apply(_this5, func_args), function (res) {
   ...
   */
  const filter = _async(function (arr, func) {
    const _this4 = this;
    // undefined inputs always return undefined
    if (typeof arr === 'undefined') {
      return undefined;
    ...
    return _continue(_forTo(arr, function (i) {
      ...
      var func_args = hofFuncArgs(func, entry, i, arr);
      // invoke func
      return _await(func.apply(_this4, func_args), function (res) {
        if (boolean(res)) {
          result.push(entry);
        }
      });
   ...
   * @returns {Array} Map array
   */
  const map = _async(function (arr, func) {
    const _this3 = this;
    // undefined inputs always return undefined
    if (typeof arr === 'undefined') {
      return undefined;
    ...
    return _continue(_forTo(arr, function (i) {
      ...
      // invoke func
      return _await(func.apply(_this3, func_args), function (res) {
        if (typeof res !== 'undefined') {
          result.push(res);
        }
      });
   ...
   */
  const split = _async(function (str, separator, limit) {
    // undefined inputs always return undefined
      ...
      if (typeof limit === 'undefined' || limit > 0) {
        return _invokeIgnored(function () {
          if (typeof separator === 'string') {
            ...
            var count = 0;
            return _await(evaluateMatcher(separator, str), function (matches) {
              return _invokeIgnored(function () {
                if (typeof matches !== 'undefined') {
                  var start = 0;
                  return _continue(_for(function () {
                    return typeof matches !== 'undefined' && (typeof limit === 'undefined' || count < limit);
                  }, void 0, function () {
                    result.push(str.substring(start, matches.start));
                    start = matches.end;
                    return _await(evaluateMatcher(matches.next), function (_evaluateMatcher3) {
                      matches = _evaluateMatcher3;
                      count++;
                    });
                  }), function () {
   ...
   */
  const replace = _async(function (str, pattern, replacement, limit) {
    let _exit = false;
    const _this2 = this;
    // undefined inputs always return undefined
    if (typeof str === 'undefined') {
      ...
      if (typeof limit === 'undefined' || limit > 0) {
        ...
        return function () {
          if (typeof pattern === 'string') {
            ...
            return _await(evaluateMatcher(pattern, str), function (matches) {
              let _exit2 = false;
              return function () {
                if (typeof matches !== 'undefined') {
                  return _continue(_for(function () {
                    return !_exit2 && typeof matches !== 'undefined' && (typeof limit === 'undefined' || count < limit);
                  }, void 0, function () {
                    result += str.substring(position, matches.start);
                    var replacedWith = replacer.apply(self, [matches]);
                    return _invoke(function () {
                      if (isPromise(replacedWith)) {
                        return _await(replacedWith, function (_replacedWith) {
                          replacedWith = _replacedWith;
                        });
                      }
                    }, function () {
                      ...
                      count++;
                      return _await(evaluateMatcher(matches.next), function (_evaluateMatcher2) {
                        matches = _evaluateMatcher2;
                      });
                    });
                  }), function (_result3) {
   ...
   * @returns {Array} The array of match objects
   */
  const match = _async(function (str, regex, limit) {
    // undefined inputs always return undefined
    if (typeof str === 'undefined') {
      return undefined;
    }
    ...
    return _invoke(function () {
      if (typeof limit === 'undefined' || limit > 0) {
        var count = 0;
        return _await(evaluateMatcher(regex, str), function (matches) {
          return _invokeIgnored(function () {
            if (typeof matches !== 'undefined') {
              return _continueIgnored(_for(function () {
                return typeof matches !== 'undefined' && (typeof limit === 'undefined' || count < limit);
                ...
                return _await(evaluateMatcher(matches.next), function (_evaluateMatcher) {
                  matches = _evaluateMatcher;
                  count++;
                });
              }));
            }
   ...
   */
  const contains = _async(function (str, token) {
    // undefined inputs always return undefined
    if (typeof str === 'undefined') {
      return undefined;
    }
    ...
    return _invoke(function () {
      if (typeof token === 'string') {
        ...
        return _await(evaluateMatcher(token, str), function (matches) {
   ...
   */
  const evaluateMatcher = _async(function (matcher, str) {
    const _this = this;
    var result = matcher.apply(_this, [str]); // eslint-disable-line no-useless-call
    return _invoke(function () {
      if (isPromise(result)) {
